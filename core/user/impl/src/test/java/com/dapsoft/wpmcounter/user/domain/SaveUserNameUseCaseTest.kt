...
class SaveUserNameUseCaseTest {
    ...
    @Test
    fun `invoke with valid name trims whitespace saves and returns success`() = runTest {
    ...
    @Test
    fun `invoke with name without whitespace saves and returns success`() = runTest {
        coEvery { userRepository.saveUserName("testName") } returns Unit
    ...
    @Test
    fun `invoke with blank name returns failure does not save logs error`() = runTest {
    ...
    @Test
    fun `invoke with empty name returns failure does not save logs error`() = runTest {
        val result = useCase.invoke("")
    ...
    @Test
    fun `invoke repository failure returns failure logs error`() = runTest {
    ...
    @Test
    fun `invoke cancellation rethrows does not swallow cancellation`() = runTest {
    ...
    @Test
    fun `invoke failure does not swallow exception type`() = runTest {
